    ...
    <>
        ...
        <div style={{ display: 'flex', gap: 60, flexWrap: 'wrap', alignItems: 'flex-start' }}>
          ...
          <div style={{ flex: '1 1 50%', minWidth: 260 }}>
            {[
              ...
              ['Pr\u00eat relais', 'Acqu\u00e9rir avant de vendre, avec un pont de financement s\u00e9curis\u00e9.'],
              ['Cr\u00e9dit investisseur', 'Montage sp\u00e9cifique pour l\u2019investissement locatif : diff\u00e9r\u00e9, amortissement.'],
              ['Financement transfrontalier', 'Solutions pour les r\u00e9sidents belges, luxembourgeois et suisses.']
      ...
      <Sec bg="#111C33">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(240px,1fr))', gap: 20, marginTop: 32 }}>
          {[
            ['Ind\u00e9pendance', 'Nous ne sommes li\u00e9s \u00e0 aucune banque. Notre conseil est 100% objectif.'],
            ['Rapidit\u00e9', 'R\u00e9ponse de principe en 48h, offre ferme en 2 semaines.'],
            ['Transparence', 'Aucun frais cach\u00e9. Nos honoraires sont clairement pr\u00e9sent\u00e9s en amont.'],
            ['Expertise', 'Sp\u00e9cialistes du neuf et du financement transfrontalier depuis 2018.']
