  ...
  const submit=async()=>{
    ...
    try{
      await Promise.all([
        ...
        fetch('https://n8n.viveo-patrimoine.fr/webhook/nouveau-lead',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({prenom:f.prenom,nom:f.nom,email:f.email,telephone:f.telephone,message:msg})})
      ]);
    }catch(e){}
    setSent(true);
  };
