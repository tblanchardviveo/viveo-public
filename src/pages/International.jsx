    ...
    <>
      ...
      <Sec bg="#F7F5F1">
        ...
        <div style={{ display: 'flex', gap: 60, flexWrap: 'wrap', alignItems: 'flex-start' }}>
          ...
          <div style={{ flex: '1 1 50%', minWidth: 260, display: 'flex', gap: 12, flexWrap: 'wrap' }}>
            {["C\u00f4te d'Azur", "C\u00f4te d'Opale", 'M\u00e9diterran\u00e9e', 'Alpes'].map((z, i) => <span key={i} style={{ padding: '14px 28px', borderRadius: 24, background: 'rgba(166,124,82,0.12)', color: '#A67C52', fontFamily: "'Raleway',sans-serif", fontWeight: 500, fontSize: 13, letterSpacing: '0.06em' }}>{z}</span>)}
          </div>
        </div>
      </Sec>
      ...
      <Sec bg="#111C33">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(240px,1fr))', gap: 20, marginTop: 32 }}>
          {[
            ['100% \u00e0 distance', 'Tout le parcours peut se faire en visio et signature \u00e9lectronique.'],
            ['Interlocuteur unique', 'Un chef de projet d\u00e9di\u00e9 qui parle votre langue.'],
            ['R\u00e9seau bancaire', 'Partenaires sp\u00e9cialis\u00e9s dans le financement des non-r\u00e9sidents.'],
            ['Expertise fiscale', 'Ma\u00eetrise des conventions bilat\u00e9rales et de la fiscalit\u00e9 crois\u00e9e.']
