      ...
      <header style={{ position: 'sticky', top: 0, zIndex: 100, background: 'var(--navy-deep)', backdropFilter: 'blur(12px)', borderBottom: '1px solid rgba(255,255,255,0.06)', height: 72 }}>
        <div style={{ width: '100%', padding: '0 32px', display: 'flex', alignItems: 'center', height: '100%', boxSizing: 'border-box', gap: 0 }}>
          ...
          <nav style={{ display: 'flex', alignItems: 'center', gap: 20, flex: 1, marginLeft: 24 }}>
            ...
            <Link to="/approche-viveo" style={linkStyle} className="nav-hide-mobile" onMouseEnter={e => e.target.style.color='#C4976A'} onMouseLeave={e => e.target.style.color='rgba(255,255,255,0.6)'}>Notre Approche</Link><Link to="/financement" style={linkStyle} className="nav-hide-mobile" onMouseEnter={e => e.target.style.color='#C4976A'} onMouseLeave={e => e.target.style.color='rgba(255,255,255,0.6)'}>Financement</Link><Link to="/simulateurs" style={{ ...linkStyle, color: "#A67C52", fontWeight: 600 }} className="nav-hide-mobile" onMouseEnter={e => e.target.style.color="#fff"} onMouseLeave={e => e.target.style.color="#A67C52"}>Simulateurs</Link><Link to="/blog" style={linkStyle} className="nav-hide-mobile" onMouseEnter={e => e.target.style.color='#C4976A'} onMouseLeave={e => e.target.style.color='rgba(255,255,255,0.6)'}>Blog</Link><Link to="/diagnostic" style={{ ...linkStyle, color: '#C4976A', fontWeight: 600 }} className="nav-hide-mobile" onMouseEnter={e => e.target.style.color='#fff'} onMouseLeave={e => e.target.style.color='#C4976A'}>Diagnostic gratuit</Link>
