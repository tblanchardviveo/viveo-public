...
export default function BanquesV3() {
  return (
    <section data-bg="#111C33" style={{ background: '#111C33', padding: '15vh 6vw' }}>
      ...
      <h2 style={{ fontFamily: "'Playfair Display',Georgia,serif", fontWeight: 300, fontSize: 'clamp(32px,4.5vw,60px)', color: '#fff', lineHeight: 1.0, margin: '0 0 24px' }}>
        Votre banquier vous conseille.<br />
        <em style={{ color: '#C4976A', fontStyle: 'italic' }}>Pour qui travaille-t-il ?</em>
      </h2>

      <p style={{ fontFamily: "'Raleway',sans-serif", fontWeight: 300, fontSize: 17, color: 'rgba(255,255,255,0.50)', maxWidth: 560, lineHeight: 1.8, margin: '0 0 64px' }}>
      ...
      <div style={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
        {/* Reseaux */}
        <div style={{ flex: 1, minWidth: 300, background: 'rgba(255,255,255,0.03)', borderRadius: '3px 0 0 3px', padding: '40px 36px' }}>
        ...
        {/* VIVEO */}
        <div style={{ flex: 1, minWidth: 300, background: 'rgba(166,124,82,0.08)', border: '1px solid rgba(166,124,82,0.20)', borderRadius: '0 3px 3px 0', padding: '40px 36px' }}>
