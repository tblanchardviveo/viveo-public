    ...
    <div>
      {hasCoords && (
        <iframe
          ...
          src={`https://www.openstreetmap.org/export/embed.html?bbox=${longitude - 0.018},${latitude - 0.012},${longitude + 0.018},${latitude + 0.012}&layer=mapnik&marker=${latitude},${longitude}`}
